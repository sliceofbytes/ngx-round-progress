# NGX Round Progress (Angular SVG round progressbar)
Angular module that uses SVG to create a circular progressbar  

Updated version of [angular-svg-round-progressbar](https://github.com/crisbeto/angular-svg-round-progressbar) for Angular 9.
